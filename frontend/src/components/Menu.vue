  ...
  <nav class="flex items-center justify-between bg-white relative shadow text-gray-600">
    ...
    <div ref="menuElements" class="flex flex-row h-20 items-center bg-transparent mr-2 md:m-0">
      <router-link to="/likeds" class="menu-element">
        ...
        <span class="hidden lg:block">Polubione</span>
      </router-link>
      <router-link to="/conversations" class="menu-element">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z" />
        </svg>
        <span class="hidden lg:block">Konwersacje</span>
      </router-link>
      <router-link to="/dashboard" class="menu-element" v-if="jwt">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
        </svg>
        <span class="hidden lg:block">Moje konto</span>
      </router-link>
      ...
      <router-link to="/help" class="menu-element">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
