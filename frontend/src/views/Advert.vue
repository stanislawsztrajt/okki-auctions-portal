<template>
  <div class=" h-screen">
    <Menu />
    <main class=" h-5/6 flex justify-center items-center relative top-1/4 mt-12 sm:top-1/3 xl:top-0">
      <div class=" w-11/12 bg-white p-6 shadow-2xl grid grid-cols-1 xl:grid-cols-9">
        ...
        <div class="col-span-2 ml-10 flex flex-col mt-12 xl:mt-0 xl:border-l-2">
          ...
          <button class="-ml-10 xl:ml-6 mt-8 text-center text-xl bg-green-600 rounded-xl p-2 text-white hover:opacity-80 duration-100">
          ...
          <button class="-ml-10 xl:ml-6 mt-3 text-center text-xl bg-red-600 rounded-xl p-2 text-white hover:opacity-80 duration-100">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 inline mb-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
